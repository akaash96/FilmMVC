...
namespace FilmMVC.Controllers
{
    public class MovieStoreController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MovieID,MovieName,MovieDescription")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MovieID,MovieName,MovieDescription")] Movie movie)
        {
            if (ModelState.IsValid)
            {
